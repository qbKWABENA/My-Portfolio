    ...
    >
      ...
      >
        <div className="lg:col-span-6 relative">
          ...
          <Reveal delay={0.65}>
            <span className="block" style={{ fontSize: "clamp(1.25rem, 3.5vw, 2rem)", color: "var(--forest)", fontWeight: 500 }}>Graphic Designer</span>
          </Reveal>
        ...
        >
          <div className="sm:col-span-3 text-[10px] sm:text-xs uppercase tracking-[0.25em]" style={{ color: "var(--ink-soft)" }}>
            (Now)<br />
            <span style={{ color: "var(--ink)" }}>Cybersecurity Student</span>
          </div>
          <p
